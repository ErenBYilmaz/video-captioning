...
RUN pip install matplotlib numpy pandas scipy tabulate cachetools pygments websocket-client opencv-python pysrt requests cv2watermark openai pytube==15.0.0 moviepy
